...
def main():
    ...
    chosen_algorithm = bubble_sort_visualizer  # Start with bubble sort
        ...
        for event in pygame.event.get():
            if event.type == pygame.QUIT:
                ...
                if event.key == pygame.K_b:
                    chosen_algorithm = bubble_sort_visualizer
                elif event.key == pygame.K_m:
                    chosen_algorithm = merge_sort_visualizer
                elif event.key == pygame.K_q:
                    chosen_algorithm = quick_sort_visualizer
